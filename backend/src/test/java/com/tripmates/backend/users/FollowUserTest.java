...
public class FollowUserTest {
	...
	void testGivenJwtOfUser_WhenFollowNoExistenteUser_ThenShouldFailAndReturnError404() throws Exception {
		...
		ResponseEntity<String> response = restTemplate.exchange(testHelper.url("/users/" + userIdToFollow + "/follow"),
				HttpMethod.POST, entity, String.class);
		assertEquals(HttpStatus.NOT_FOUND, response.getStatusCode());
		String expectedJson = "{" + "\"type\":\"about:blank\"," + "\"title\":\"Not Found Error\"," + "\"status\":404,"
				+ "\"detail\":\"El usuario no existe\"," + "\"instance\":\"/users/id-inexistente/follow\"" + "}";
	...
	void testGivenTwoExistingUsers_WhenFollowUser_ThenShouldSucceed() {
		...
		ResponseEntity<String> response = restTemplate.exchange(
				testHelper.url("/users/" + accountSaved.getId() + "/follow"), HttpMethod.POST, entity, String.class);
	...
	void testGivenTwoExistingUsers_WhenFollowUser_ThenAppearInFollowersOnDb() {
		...
		headers.setBearerAuth(jwt);
		HttpEntity<?> entity = new HttpEntity<>(headers);
		restTemplate.exchange(testHelper.url("/users/" + followedAccountSaved.getId() + "/follow"), HttpMethod.POST,
				entity, String.class);
	...
	void testGivenUserAccount_WhenFollowBussinesAccount_ThenShouldFailAndReturnError400() throws Exception {
		...
		HttpEntity<?> entity = new HttpEntity<>(headers);
		ResponseEntity<String> response = restTemplate.exchange(
				testHelper.url("/users/" + bussinesAccountSaved.getId() + "/follow"), HttpMethod.POST, entity,
				String.class);
		assertEquals(400, response.getStatusCode().value());
		String expectedJson = "{" + "\"type\":\"about:blank\"," + "\"title\":\"Bad Request\"," + "\"status\":400,"
				+ "\"detail\":\"No puedes seguir/dejar de seguir a un cuenta de negocio\"," + "\"instance\":\"/users/"
				+ bussinesAccountSaved.getId() + "/follow\"" + "}";
		JSONAssert.assertEquals(expectedJson, response.getBody(), true);
	}
	...
	void testGivenBusinessAccount_WhenFollowUserAccount_ThenShouldFailAndReturnError400() throws Exception {
		...
		HttpEntity<?> entity = new HttpEntity<>(headers);
		ResponseEntity<String> response = restTemplate.exchange(
				testHelper.url("/users/" + userAccountSaved.getId() + "/follow"), HttpMethod.POST, entity,
				String.class);
		assertEquals(400, response.getStatusCode().value());
		String expectedJson = "{" + "\"type\":\"about:blank\"," + "\"title\":\"Bad Request\"," + "\"status\":400,"
				+ "\"detail\":\"No tienes permiso para realizar esta accion\"," + "\"instance\":\"/users/"
				+ userAccountSaved.getId() + "/follow\"" + "}";
		JSONAssert.assertEquals(expectedJson, response.getBody(), true);
	}
	...
	void testGivenBusinessAccount_WhenFollowBusinessAccount_ThenShouldFailAndReturnError400() throws Exception {
		...
		HttpEntity<?> entity = new HttpEntity<>(headers);
		ResponseEntity<String> response = restTemplate.exchange(
				testHelper.url("/users/" + businessAccountSaved.getId() + "/follow"), HttpMethod.POST, entity,
				String.class);
		assertEquals(400, response.getStatusCode().value());
		String expectedJson = "{" + "\"type\":\"about:blank\"," + "\"title\":\"Bad Request\"," + "\"status\":400,"
				+ "\"detail\":\"No tienes permiso para realizar esta accion\"," + "\"instance\":\"/users/"
				+ businessAccountSaved.getId() + "/follow\"" + "}";
		JSONAssert.assertEquals(expectedJson, response.getBody(), true);
	}
	...
	void testGivenUserAccount_WhenFollowItSelf_ThenShouldFailAndReturnError400() throws Exception {
		...
		headers.setBearerAuth(jwt);
		HttpEntity<?> entity = new HttpEntity<>(headers);
		ResponseEntity<String> response = restTemplate.exchange(testHelper.url("/users/" + me.getId() + "/follow"),
				HttpMethod.POST, entity, String.class);
		assertEquals(400, response.getStatusCode().value());
		String expectedJson = "{" + "\"type\":\"about:blank\"," + "\"title\":\"Bad Request\"," + "\"status\":400,"
				+ "\"detail\":\"No puedes dejar de seguirte/seguirte a ti mismo\"," + "\"instance\":\"/users/"
				+ me.getId() + "/follow\"" + "}";
		JSONAssert.assertEquals(expectedJson, response.getBody(), true);
	}
	...
	void testGivenUserAccount_WhenUnfollowItSelf_ThenShouldFailAndReturnError400() throws Exception {
		...
		headers.setBearerAuth(jwt);
		HttpEntity<?> entity = new HttpEntity<>(headers);
		ResponseEntity<String> response = restTemplate.exchange(testHelper.url("/users/" + me.getId() + "/unfollow"),
				HttpMethod.POST, entity, String.class);
		assertEquals(400, response.getStatusCode().value());
		String expectedJson = "{" + "\"type\":\"about:blank\"," + "\"title\":\"Bad Request\"," + "\"status\":400,"
				+ "\"detail\":\"No puedes dejar de seguirte/seguirte a ti mismo\"," + "\"instance\":\"/users/"
	...
	void testGivenUserAccount_WhenUnfollowAnotherUserNotFollowed_ThenShouldFailAndReturnError400() throws Exception {
		...
		HttpEntity<?> entity = new HttpEntity<>(headers);
		ResponseEntity<String> response = restTemplate.exchange(
				testHelper.url("/users/" + userAccountSaved.getId() + "/unfollow"), HttpMethod.POST, entity,
				String.class);
		assertEquals(400, response.getStatusCode().value());
		String expectedJson = "{" + "\"type\":\"about:blank\"," + "\"title\":\"Bad Request\"," + "\"status\":400,"
				+ "\"detail\":\"No puedes dejar de seguir a alguien que no sigues\"," + "\"instance\":\"/users/"
				+ userAccountSaved.getId() + "/unfollow\"" + "}";
		JSONAssert.assertEquals(expectedJson, response.getBody(), true);
	}
	...
	void testGivenNewUserAccount_WhenGetFollowings_ThenShouldSuccessAndReturn200WithFollowings() throws Exception {
		...
		headers.setBearerAuth(jwt);
		HttpEntity<?> entity = new HttpEntity<>(headers);
		ResponseEntity<String> response = restTemplate.exchange(testHelper.url("/users/me/followings"), HttpMethod.GET,
				entity, String.class);
		String expectedJson = "{" + "\"followings\":[]" + "}";
	...
	void testGivenNewUserAccount_WhenGetFollowers_ThenShouldSuccessAndReturn200WithFollowers() throws Exception {
		...
		headers.setBearerAuth(jwt);
		HttpEntity<?> entity = new HttpEntity<>(headers);
		ResponseEntity<String> response = restTemplate.exchange(testHelper.url("/users/me/followers"), HttpMethod.GET,
				entity, String.class);
		String expectedJson = "{" + "\"followers\":[]" + "}";
		assertEquals(200, response.getStatusCode().value());
		JSONAssert.assertEquals(expectedJson, response.getBody(), true);
	}

	@Test
	void testGivenMeFollowingAUserAccount_WhenGetFollowers_ThenShouldSuccessAndReturn200WithFollowers()
			throws Exception {
		...
		ResponseEntity<String> response = restTemplate.exchange(testHelper.url("/users/me/followings"), HttpMethod.GET,
				entity, String.class);
		String expectedJson = "{" + "\"followings\":[{" + "\"name\":\"Other\"," + "\"email\":\"other@example.com\","
				+ "\"role\":\"USER\"" + "}]" + "}";
		assertEquals(200, response.getStatusCode().value());
	...
	private void followUserWithPreviusJwt(String jwt, String followedUserId) {
		...
		headers.setBearerAuth(jwt);
		HttpEntity<?> entity = new HttpEntity<>(headers);
		restTemplate.exchange(testHelper.url("/users/" + followedUserId + "/follow"), HttpMethod.POST, entity,
				String.class);
	}
