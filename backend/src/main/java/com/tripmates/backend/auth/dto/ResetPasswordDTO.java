...
public record ResetPasswordDTO(
		...
		@Schema(description = "New password", example = "newPassword123") @NotBlank(message = "Password is required") @Size(min = 8, message = "Password must be at least 8 characters long") String newPassword) {
}
