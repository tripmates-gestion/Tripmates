...
public record AuthRegisterRequestDTO(
        @Schema(description = "User's username") @NotBlank(message = "The username cannot be empty to register a user.") String name,

        @Schema(description = "User's email") @NotBlank(message = "The user's email cannot be empty to register a user.") @Email(message = "The provided email is not valid.") String email,
