...
public record UserResumeResponseDTO(@Schema(description = "User's username") String name,
		@Schema(description = "User's email") String email, @Schema(description = "User's role") Role role,
