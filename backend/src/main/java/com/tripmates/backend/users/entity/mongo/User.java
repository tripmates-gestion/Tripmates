...
public class User implements UserDetails {
     ...
     * Only allowed in BUSINESS account.
     */
    @NotNull
    ...
    /**
     * User's business available days.
     * Only allowed in BUSINESS account.
     */
    private List<DayOfWeek> openingDays;

    /**
     * User's business attention schedule.
     * Only allowed in BUSINESS account.
     */
    private AttentionSchedule attentionSchedule;

    /**
     * User's business particular closing days.
     * Only allowed in BUSINESS account.
     */
