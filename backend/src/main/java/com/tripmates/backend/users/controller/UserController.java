...
public class UserController {
	...
	@Operation(summary = "Append one menu item (multipart)", description = DocumentationObjectsExamples.RESTAURANT_APPEND_EXAMPLE)
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Menu item appended successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = AccountResumeResponseDTO.class))),
	...
	@Operation(summary = "Update one menu item by index (multipart)", description = DocumentationObjectsExamples.RESTAURANT_UPDATE_EXAMPLE)
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Menu item updated successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = AccountResumeResponseDTO.class))),
			@ApiResponse(responseCode = "404", description = "Account not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDTO.class))) })
	public ResponseEntity<?> updateMenuItem(@AuthenticationPrincipal UserDetails userDetails,
			...
			@Parameter(description = "Optional JSON string containing updated non-image fields (foodName, price, description) and deletePhotoIndexes to remove specific photos by 0-based indexes. If omitted, only photos will be modified.") @RequestPart(value = "data", required = false) String data,
	...
	@Operation(summary = "Delete one menu item by index", description = """
			...
			""")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Menu item deleted successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = AccountResumeResponseDTO.class))),
			@ApiResponse(responseCode = "404", description = "Account not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDTO.class))) })
	...
	@Operation(summary = "Append one room pack (multipart)", description = DocumentationObjectsExamples.HOSTING_APPEND_EXAMPLE)
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Room pack appended successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = AccountResumeResponseDTO.class))),
			@ApiResponse(responseCode = "404", description = "Account not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDTO.class))) })
	...
	@Operation(summary = "Update one room pack by index (multipart)", description = DocumentationObjectsExamples.HOSTING_UPDATE_EXAMPLE)
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Room pack updated successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = AccountResumeResponseDTO.class))),
			@ApiResponse(responseCode = "404", description = "Account not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDTO.class))) })
	public ResponseEntity<?> updateRoomPack(@AuthenticationPrincipal UserDetails userDetails,
			...
			@Parameter(description = "Optional JSON string containing updated non-image fields (checkInDate, checkOutDate, numberOfGuests, services, price, description) and deletePhotoIndexes to remove specific photos by 0-based indexes. If omitted, only photos will be modified.") @RequestPart(value = "data", required = false) String data,
	...
	@Operation(summary = "Delete one room pack by index", description = """
			...
			""")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Room pack deleted successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = AccountResumeResponseDTO.class))),
			@ApiResponse(responseCode = "404", description = "Account not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDTO.class))) })
	...
	@PostMapping(value = "/search/business", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
