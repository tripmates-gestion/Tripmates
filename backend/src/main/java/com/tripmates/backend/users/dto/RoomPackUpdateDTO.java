...
public record RoomPackUpdateDTO(
        ...
        @Schema(description = "Room's services") @JsonProperty("services") @JsonSetter(nulls = Nulls.AS_EMPTY) List<String> services,
        ...
        @Schema(description = "Optional list of 0-based photo indexes to delete from the room pack") @JsonProperty("deletePhotoIndexes") @JsonSetter(nulls = Nulls.AS_EMPTY) List<Integer> deletePhotoIndexes
) {
}
