...
import com.tripmates.backend.publications.dto.BusinessPublicationResponseDTO;
import com.tripmates.backend.publications.entity.mongo.Publication;
import java.util.ArrayList;>>>>>>>origin/dev-front
...
>>>>>>> origin/dev-front
	...
	=======if(dto.title()!=null)publication.setTitle(dto.title());if(dto.description()!=null)publication.setDescription(dto.description());if(dto.phoneNumber()!=null)publication.setPhoneNumber(dto.phoneNumber());if(dto.email()!=null)publication.setEmail(dto.email());if(dto.location()!=null)publication.setLocation(dto.location());if(dto.openingDays()!=null)publication.setOpeningDays(dto.openingDays());if(dto.attentionSchedule()!=null)publication.setAttentionSchedule(dto.attentionSchedule());if(dto.exceptionalClosingDays()!=null)publication.setExceptionalClosingDays(dto.exceptionalClosingDays());
	...
	publicationRepository.save(publication);return BusinessPublicationResponseDTO.fromPublication(publication);
