...
public record BusinessPublicationResponseDTO(String id, String title, String description, List<DayOfWeek> openingDays,
		...
		String location, List<String> imageUrls, List<String> tags, String ownerId, String ownerUsername,
		String ownerAvatarUrl, Date createdAt) {
	public static BusinessPublicationResponseDTO fromPublication(Publication publication) {
		return new BusinessPublicationResponseDTO(publication.getId(), publication.getTitle(),
				...
				publication.getLocation(), publication.getImageUrls(), publication.getTags(), publication.getOwnerId(),
