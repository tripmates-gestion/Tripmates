...
public class CommunityController {
	...
	@Operation(summary = "Invite a user to a plan",
	...
	@ApiResponses(
			value = {
					...
					@ApiResponse(
							responseCode = "404", description = "User or plan not found",
							content = @Content(mediaType = "application/json",
									schema = @Schema(implementation = ErrorDTO.class))),
					@ApiResponse(responseCode = "401",
							...
							content = @Content(mediaType = "application/json",
									schema = @Schema(implementation = ErrorDTO.class))) })
	public ResponseEntity<?> inviteUserToPlan(@PathVariable("planId") String planId,
			@PathVariable("userId") String userId, @AuthenticationPrincipal UserDetails userDetails) {
	...
	@ApiResponses(
			value = {
					...
					@ApiResponse(responseCode = "404", description = "Plan not found",
							content = @Content(mediaType = "application/json",
									schema = @Schema(implementation = ErrorDTO.class))) })
	public ResponseEntity<?> acceptInvitation(@PathVariable("planId") String planId,
	...
	@ApiResponses(
			value = {
					...
					@ApiResponse(responseCode = "404", description = "Plan not found",
							content = @Content(mediaType = "application/json",
									schema = @Schema(implementation = ErrorDTO.class))) })
	public ResponseEntity<?> declineInvitation(@PathVariable("planId") String planId,
			@AuthenticationPrincipal UserDetails userDetails) {
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "404", description = "User not found",
					content = @Content(mediaType = "application/json",
							schema = @Schema(implementation = ErrorDTO.class))) })
	public ResponseEntity<?> getPlanById(@PathVariable("planId") String planId,
			@AuthenticationPrincipal UserDetails userDetails) {
