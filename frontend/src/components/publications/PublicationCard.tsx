...
type Props = {
  ...
  onAddToBoard?: (
    ...
    p: BusinessPublicationResponseDTO,
    token: string
  ) => Promise<void>;
};

const IMG_PLACEHOLDER_URL =
  "https://images.unsplash.com/photo-1610513320995-1ad4bbf25e55?ixlib=rb-4.1.0&auto=format&fit=crop&q=80&w=2070";
const DAYS_ORDER: Array<
  | "MONDAY"
  | "TUESDAY"
  | "WEDNESDAY"
  | "THURSDAY"
    ...
    <>
      ...
      >
        ...
        <CardContent sx={{ p: 2 }}>
          ...
          <Typography variant="caption" color="text.secondary" mt={1.25}>
